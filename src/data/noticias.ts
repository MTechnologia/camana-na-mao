import { FileText, Building, Stethoscope, GraduationCap, Bus, TreePine, Palette, Users, LucideIcon } from "lucide-react";
...
export const categoryConfig: Record<NewsCategory, { label: string; color: string; icon: LucideIcon }> = {
  legislativo: { 
    label: 'Legislativo', 
...
export function getCategoryConfig(category: string): { label: string; color: string; icon: LucideIcon } {
  return categoryConfig[category as NewsCategory] || {
    label: category,
