...
import { ENABLE_EXTENDED_OPERATION_NAV, ENABLE_NAV_DROPDOWN_MENUS } from "@/config/featureFlags";

export type { NavGroup, NavItem, NavPermission, NavSection } from "@/config/adminNav.types";
