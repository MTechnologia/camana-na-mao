...
const TestInfraRating = () => {
  ...
  const FIVE_LEVEL_LABELS = ["Péssimo", "Ruim", "Regular", "Bom", "Excelente"];
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold tracking-tight text-primary">
            Teste: Pergunta de Infraestrutura
          </h1>
          ...
          <CardContent className="p-6 space-y-6">
            <div className="bg-muted p-4 rounded-lg relative">
              <p className="text-sm font-medium mb-4">
                Como você avalia a **infraestrutura** (instalações, limpeza e conservação)? De 1 a 5
                estrelas.
              </p>

              <InlineRatingPicker dimensionKey="infraestrutura" onSelect={handleRating} />
              ...
              <Card className="bg-green-500/10 border-green-500/20">
                <CardContent className="p-4">
                  ...
                  <div className="space-y-1 text-sm text-green-600 dark:text-green-300">
                    <p>
                      <strong>Label:</strong> {result.displayLabel}
                    </p>
                    <p>
                      <strong>Score:</strong> {result.score}
                    </p>
                    <p>
                      <strong>Marcador Gerado:</strong>{" "}
                      <code className="bg-green-500/20 px-1 rounded">
                        [DIM_RATING:infraestrutura:{result.score}]
                      </code>
                    </p>
