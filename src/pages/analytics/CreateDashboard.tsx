...
import {
  ...
  type WidgetConfig,
} from "@/components/analytics/DashboardPreview";
...
export default function CreateDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader title="Criar Painel Personalizado" onBack={() => navigate("/paineis")} />
          ...
          <TabsContent value="preview">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Visualize como seu painel ficará quando publicado</CardDescription>
              </CardHeader>
              <CardContent>
