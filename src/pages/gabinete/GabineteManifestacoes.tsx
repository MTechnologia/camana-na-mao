        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Consulta em modo leitura dos itens que chegaram ao gabinete e ainda não foram concluídos.
            </p>
          </div>
          ...
          <CardContent className="space-y-3">
            {loading ? (
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-muted-foreground">Quando novos encaminhamentos chegarem ao gabinete, eles aparecerão aqui.</p>
              </div>
            ) : (
              items.map((item) => {
                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-3">
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {item.protocolCode ? <Badge variant="outline">Protocolo {item.protocolCode}</Badge> : null}
                          {item.manifestStatus ? (
                            <Badge variant="outline">
                              Manifestação: {statusLabels[item.manifestStatus] || item.manifestStatus}
                            </Badge>
                          ) : null}
                          <Badge>
                            Encaminhamento: {statusLabels[item.referralStatus] || item.referralStatus}
                          </Badge>
                        </div>
                        <div>
