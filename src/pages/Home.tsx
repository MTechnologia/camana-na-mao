...
const Home = () => {
  ...
  const shortcuts = [
    { id: 1, title: "Relato Urbano", icon: MessageSquare, color: "text-cyan-500", bgColor: "bg-cyan-50", path: "/ia?journey=urban_report" },
    ...
    { id: 4, title: "Transporte", icon: Bus, color: "text-orange-500", bgColor: "bg-orange-50", path: "/ia?journey=transport" },
