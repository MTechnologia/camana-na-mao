  ...
  const loadConsents = async () => {
    ...
    try {
      ...
      data?.forEach((consent) => {
        ...
        if (!consentsMap[type] || 
            (consent.granted_at && (!consentsMap[type]?.granted_at || 
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  Consentimentos obrigatórios (Termos de Uso e Política de Privacidade) 
                  não podem ser revogados, pois são necessários para uso da plataforma.
                </p>
                <Button
                  variant="link"
                  size="sm"
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-yellow-800 dark:text-yellow-300">
                  Ao revogar um consentimento, algumas funcionalidades podem ficar 
                  indisponíveis. A revogação não afeta tratamentos já realizados 
