...
import { 
  GripVertical, MoreVertical, Eye, Send, Trash2,
...
export function KanbanCard({ manifest, onViewDetails, onReferral, onDelete }: KanbanCardProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragging ? 'opacity-50 shadow-lg ring-2 ring-primary' : 'hover:border-primary/50'}
          ...
          <div className="flex items-center justify-between">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {(manifest.type === 'urban' || manifest.type === 'transport' || manifest.type === 'feedback') && (
