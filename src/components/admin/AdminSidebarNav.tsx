          ...
          collapsed
            ...
            : cn(
                ...
                nested
                  ...
                  : cn(
                      "px-3",
                      isActive && "border-l-2 border-sidebar-primary pl-[calc(0.75rem-2px)]",
                    ),
              ),
          isActive
            ? collapsed
...
export function SidebarNavSection({
  ...
  return (
    <section className={cn(collapsed ? "pb-1" : "mb-5 last:mb-2")} aria-label={section.title}>
      {collapsed && sectionIndex > 0 && (
        <div className="mx-auto my-3 h-px w-9 bg-sidebar-border/80" role="separator" aria-hidden />
      )}
      {!collapsed && (
