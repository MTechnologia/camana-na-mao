...
const links = [
  ...
  },
  {
    ...
    title: 'Mapa de concentração',
    description: 'Onde as avaliações se concentram por região.',
    Icon: Map,
  },
  {
    to: '/admin/analytics',
    title: 'Análise de relatos urbanos',
    description: 'Volume e padrões — distinto das avaliações de equipamento.',
    Icon: BarChart3,
  },
] as const;

export function EquipmentRatingsExploreLinks() {
  return (
