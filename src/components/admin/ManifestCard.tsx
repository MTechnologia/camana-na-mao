...
export const ManifestCard = ({
  ...
  return (
    <div
      className={`group flex items-center gap-3 p-4 border-b last:border-b-0 hover:bg-muted/50 transition-colors ${isSelected ? 'bg-muted/30' : ''}`}
    >
      {/* Checkbox */}
      <Checkbox
        checked={isSelected}
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem onClick={handlePrimaryAction} className="md:hidden">
