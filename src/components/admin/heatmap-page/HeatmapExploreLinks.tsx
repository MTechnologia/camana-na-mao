...
import { ArrowUpRight, BarChart3, LayoutDashboard, TrendingUp } from 'lucide-react';
...
const links = [
  {
    ...
    description: 'Indicadores e território interativo no recorte global.',
    Icon: LayoutDashboard,
  },
  {
    to: '/admin/analytics',
    title: 'Análise de relatos urbanos',
    description: 'Abas de volume, sentimento, padrões e território.',
    Icon: BarChart3,
  },
  {
    to: '/admin/trends',
    title: 'Tendências temporais',
    description: 'Evolução por categoria e tipo de relato no tempo.',
    Icon: TrendingUp,
  },
] as const;

export function HeatmapExploreLinks() {
  return (
