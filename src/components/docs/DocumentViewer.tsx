            ...
            <ReactMarkdown
              ...
              components={{
                h1: ({ children }) => {
                  ...
                  return <HeadingWithLink level={1} id={id}>{children}</HeadingWithLink>;
                },
                h2: ({ children }) => {
                  const text = String(children);
                  const id = slugify(text);
                  return <HeadingWithLink level={2} id={id}>{children}</HeadingWithLink>;
                },
                h3: ({ children }) => {
                  const text = String(children);
                  const id = slugify(text);
                  return <HeadingWithLink level={3} id={id}>{children}</HeadingWithLink>;
                },
