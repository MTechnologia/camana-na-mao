...
export const SERVICE_TYPE_SVG_PATHS: Record<string, string[]> = {
  ...
  daycare: [
    "M9 12h.01",
    "M15 12h.01",
    "M9.5 9a2.5 2.5 0 0 1 5 0",
    "M12 3a6 6 0 0 1 6 6c0 2.5-1.5 4.5-3 5.5",
  ],
  park: [
    "M12 22v-4",
    "M12 18a4 4 0 0 0 4-4V8a4 4 0 0 0-8 0v6a4 4 0 0 0 4 4Z",
    "M8 22v-4",
    "M8 18a4 4 0 0 0 4-4V8a4 4 0 0 0-8 0v6a4 4 0 0 0 4 4Z",
  ],
  ...
  accessibility: [
    "M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-2H9v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2z",
  ],
