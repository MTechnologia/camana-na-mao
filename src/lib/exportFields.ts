...
const URBAN_FIELDS: readonly ExportField[] = [
  ...
  {
    id: "affected_estimate",
    dbColumn: "affected_estimate",
  ...
  {
    id: "urgency_reason",
    dbColumn: "urgency_reason",
    label: "Justificativa de urgência",
    group: "Status",
    kind: "text",
    inBasicPreset: false,
  },
...
const TRANSPORT_FIELDS: readonly ExportField[] = [
  ...
  {
    id: "personal_impact",
    dbColumn: "personal_impact",
    label: "Impacto pessoal (1-5)",
    group: "Status",
    kind: "number",
    inBasicPreset: false,
  },
  ...
  {
    id: "line_code_custom",
    dbColumn: "line_code_custom",
    label: "Código da linha (custom)",
    group: "Localização",
    kind: "text",
    inBasicPreset: false,
  },
  ...
  },
  {
    ...
    dbColumn: "accessibility_details",
  ...
  {
    id: "ai_pattern_detected",
    dbColumn: "ai_pattern_detected",
    label: "Padrão detectado (IA)",
    group: "Avançado",
    kind: "boolean",
    inBasicPreset: false,
  },
...
export function groupFields(dataset: DatasetMeta): { group: FieldGroup; fields: ExportField[] }[] {
